...
async function loadDashboard() {
  ...
  document.getElementById('statsGrid').innerHTML = `
    ...
    <div class="stat-card" style="border-left:3px solid #d8ad58"><div class="label">Phoenix</div><div class="value" style="color:#d8ad58">${prods['Phoenix'] || 0}</div></div>
    <div class="stat-card" style="border-left:3px solid #2dd4a8"><div class="label">Dayaa</div><div class="value" style="color:#2dd4a8">${prods['Dayaa'] || 0}</div></div>
